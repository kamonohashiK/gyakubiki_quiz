        ...
        <form class="row" action="{{route('questions.index')}}" method="GET">
            ...
            <div class="col-auto">
                <div class="form-check form-switch">
                    <input class="form-check-input" name="question" type="checkbox" id="flexSwitchCheckChecked" value="1" @if(session()->get('question')) checked @endif>
                    <label class="form-check-label" for="flexSwitchCheckChecked">問題文に</label>
                </div>
                <div class="form-check form-switch">
